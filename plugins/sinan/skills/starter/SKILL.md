...
2. Do not run legacy JS helpers. Inspect the target with `python3 -m scripts.sinan.cli bootstrap --target <repo> --json`, then propose starter files before writing.
