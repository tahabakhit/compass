...
name: research-fleet
description: >-
  Use when parallel research using Fleet wave mechanics. Spawns multiple scout
  agents, each investigating a different angle of the same question. Findings
  are compressed between waves. Produces a unified research brief from
