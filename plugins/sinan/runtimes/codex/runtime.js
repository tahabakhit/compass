...
module.exports = Object.freeze({
  ...
  capabilities: {
    ...
    hooks: { support: 'partial', notes: 'Supports native lifecycle hooks, including tool, permission, compaction, subagent, prompt, and stop events; adapter keeps Sinan hooks portable.' },
    workspace: { support: 'full', notes: 'Standard file and shell workflow available.' },
    worktrees: { support: 'partial', notes: 'Codex app supports native Git worktrees and handoff; CLI flows still use Sinan-managed worktrees where needed.' },
    approvals: { support: 'partial', notes: 'Approval model differs from Claude Code and needs adapter-aware policy handling.' },
    history: { support: 'partial', notes: 'Has native session persistence, but campaign state remains Sinan-owned.' },
    telemetry: { support: 'partial', notes: 'Sinan telemetry remains external to runtime-native history.' },
